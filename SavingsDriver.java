...
public class SavingsDriver {
    ...
    "alice@email.com", "555-1234", "NY", "New York", true, 1800.0,
    ...
    "extra1", "extra2", "extra3"
        ...
        aliceAccounts.add(acc3);
            ...
            SavingsAccount acc = SavingsAccount.createSavingsAccount(userid, 100);
            if(acc==null)
            {
            acc = SavingsAccount.OpenSavingsAccount(userid);
            }
            if(acc !=null)
            {
            acc.transfer(aliceAccounts, newinput, true, 300);
            acc.update();

...
public moneyMarket closeMoneyMarket() throws IOException {
    ...
    try (BufferedReader reader = Files.newBufferedReader(csvPick);
...
public static boolean  writefeeUser(String MoneyID) throws IOException{
   ...
   // ************Withdraw system**************/
public void withdrawMoneyMarket(double amt) throws IOException { //use a working variable so our data wouldn't be corrupted.
 ...
 public double transfer(CheckingAccount.Account fromAccount,
                       Scanner scanner,
    ...
    while (true) {
        ...
        if (fromChecking && fromAccount != null) {
            ...
            if (amount > fromAccount.balance) {
                System.out.println("Insufficient funds. enter a lower withdraw instead.");
                continue;
            }
            ...
            System.out.printf("Transferred $%.2f from %s to %s%n",
                    amount, fromAccount.accountID, getuserID());

        }
        // =============================
        // CASE 2: FROM EXTERNAL → MONEY MARKET
        // =============================
        else if (fromChecking) {
            ...
            System.out.printf("Transferred $%.2f from external to %s%n",
                    amount, getuserID());
        }
        // =============================
        // CASE 3: FROM MONEY MARKET → CHECKING
        // =============================
            ...
            fromAccount.addTransaction("Transfer in", amount);
            fromAccount.updateFlags();

            System.out.printf("Transferred $%.2f to %s%n",
                    amount, fromAccount.accountID);
        }
        // =============================
        // CASE 4: FROM MONEY MARKET → EXTERNAL
        // =============================
        else {
            ...
            System.out.printf("Transferred $%.2f to external%n", amount);
        }

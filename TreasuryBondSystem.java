...
public class TreasuryBondSystem {
    ...
    static class User {
        CheckingAccount.User bankUser;
        CheckingAccount.Account checking;
        CheckingAccount.SavingsAccount savings;
        List<Bond> bonds = new ArrayList<>();

        User(CheckingAccount.User bankUser, CheckingAccount.Account checking) {
    ...
    public static CheckingAccount.Account findCheckingAccount(CheckingAccount.User user, String accountID) {
    ...
    public static User createBondUser(CheckingAccount.User bankUser, String selectedCheckingID) {

...
public class BondDriver {
    ...
    public static void main(String[] args) {
        ...
        try {
            List<CheckingAccount.User> loadedUsers = CheckingAccount.readCSV(CHECKING_CSV);
            ...
            CheckingAccount.User bankUser = CheckingAccount.findUser(loadedUsers, inputID);
            if (bankUser == null) {
    ...
    private static void persistAll(List<CheckingAccount.User> loadedUsers,
                                   TreasuryBondSystem.User bondUser) {
        try {

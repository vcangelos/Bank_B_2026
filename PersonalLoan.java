...
public class PersonalLoan {
    ...
    public double calculateMonthlyPayment() {
        ...
        if (monthlyRate == 0) {
            return roundMoney(principal / loanTerm);
        }
    ...
    public boolean payMonthlyFromCheckingAndSavings(CheckingAccount.Account checking, SavingsAccount savings) throws IOException {
        ...
        if (checking != null && checking.isActive && checking.balance > 0) {
            checkingAvailable = checking.balance;
        }
    ...
    public void saveToCSV() {
        ...
        try (java.io.FileWriter writer = new java.io.FileWriter(fileName, true)) {
            ...
            if (!fileExists) {
                writer.write("LoanID,LoanType,Principal,RemainingBalance,TotalPaid,PaymentsMade,InterestRate,Approved,AutoPayEnabled,StartDate\n");
            }
